...
class JobExecutionCheckerServiceTest {
    ...
    @Test
    void getLastSuccessfulExecution_shouldReturnExecution_whenCompletedExecutionExists() {
        // Given
        String jobName = "testJob";
        ...
        JobExecution completedExecution = createJobExecution(1L, 
            BatchStatus.COMPLETED, 
            LocalDateTime.of(2025, 7, 30, 10, 0));
        JobExecution failedExecution = createJobExecution(2L, 
            BatchStatus.FAILED, 
            LocalDateTime.of(2025, 7, 29, 10, 0));

        when(jobExplorer.findJobInstancesByJobName(eq(jobName), eq(0), eq(5)))
            .thenReturn(Arrays.asList(jobInstance));
        when(jobExplorer.getJobExecutions(jobInstance))
            .thenReturn(Arrays.asList(completedExecution, failedExecution));

        // When
        JobExecution result = jobExecutionCheckerService.getLastSuccessfulExecution(jobName);
    ...
    @Test
    void getLastSuccessfulExecution_shouldReturnNull_whenNoCompletedExecutionExists() {
        // Given
        String jobName = "testJob";
    ...
    @Test
    void getLastSuccessfulExecution_shouldReturnNull_whenNoJobInstancesFound() {
        // Given
        String jobName = "nonExistentJob";
